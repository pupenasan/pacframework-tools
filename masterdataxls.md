...
- `other` - для отримання інформації про інші налаштування в форматі 
...
`DESCRIPTION` - опис технологічної змінної. При формуванні опису для DEVICE (наприклад ACT) варто вказувати призначення в дужках, тоді при автоматичному формуванні переліку ВМ буде вибрана назва, що без дужок 	
...
- `SECTION` - назва JSON файлу, куди повинні записуатися дані, але без вказівки префікса `cfg_`: може приймати значення `tags`, `chs`, `chmap`, `acts`  
...
Тут наводяться описи для входів/виходів функцінальних блоків за їх символьним ідентифікатором.
