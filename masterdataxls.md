...
`DESCRIPTION` - опис технологічної змінної. При формуванні опису для `ACT` варто вказувати призначення в дужках, тоді при автоматичному формуванні переліку ВМ буде вибрана назва, що без дужок. 	
